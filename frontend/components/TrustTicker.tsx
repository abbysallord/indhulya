  ...
  return (
    <div className="w-full overflow-hidden bg-[#5C1218] text-[#E5B94E] py-3 border-b border-[#70161E] [mask-image:linear-gradient(to_right,transparent,black_3%,black_97%,transparent)]">
      <div className="flex whitespace-nowrap animate-marquee">
        ...
        <div className="flex shrink-0 items-center justify-around w-full gap-8 text-xs font-bold tracking-widest uppercase">
        ...
        <div className="flex shrink-0 items-center justify-around w-full gap-8 text-xs font-bold tracking-widest uppercase ml-8">
          <span>★ Authentic 1 Gram Gold</span>
          <span>•</span>
          <span>Handcrafted in India</span>
          <span>•</span>
