...
const ALL_PRODUCTS = [
  ...
  { id: 4, name: "Varna Versatile Choker", category: "Chokers", price: "₹3,200", image: "https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?q=80&w=600&fit=crop" },
  { id: 5, name: "Aavya Gutta Pusalu", category: "Necklaces", price: "₹2,800", image: "https://images.unsplash.com/photo-1595868228343-43fa14fb6168?q=80&w=600&fit=crop" },
  { id: 6, name: "Mayura Peacock Long Haram", category: "Long Harams", price: "₹3,500", image: "https://images.unsplash.com/photo-1574621100236-d26baa151125?q=80&w=600&fit=crop" },
  { id: 7, name: "Lakshmi Mahotsav Kada", category: "Bangles", price: "₹850", image: "https://images.unsplash.com/photo-1606293926075-69a00dbfde81?q=80&w=600&fit=crop" },
  { id: 8, name: "Star-Burst CZ Bangles", category: "Bangles", price: "₹999", image: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?q=80&w=600&fit=crop" },
  { id: 9, name: "Aura Minimalist Studs", category: "Earrings", price: "₹450", image: "https://images.unsplash.com/photo-1599643477877-530eb83abc8e?q=80&w=600&fit=crop" },
  { id: 10, name: "Royal Rajputi Nath", category: "Nose Rings", price: "₹1,500", image: "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?q=80&w=600&fit=crop" },
  { id: 11, name: "Classic Gold Chain", category: "Chains", price: "₹2,100", image: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?q=80&w=600&fit=crop" },
  { id: 12, name: "Bridal Complete Set", category: "Bridal Sets", price: "₹15,000", image: "https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?q=80&w=600&fit=crop" },
];
